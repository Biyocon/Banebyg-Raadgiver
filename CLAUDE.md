...
| `CLAUDE.md` | Working rules, architecture, repo contracts | Code conventions |
...
# gulp bundle --ship      — Bundle for deployment
# gulp package-solution --ship  — Create .sppkg for app catalog
```
